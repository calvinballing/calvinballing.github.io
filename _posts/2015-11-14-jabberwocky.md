...
title: Jabberwocky in Common Words
homedisplay: featimg
...
Some time after [xkcd](xkcd.com)'s [Up Goer Five](https://xkcd.com/1133/) comic using only the ten Hundred most common words, and after the [Thing Explainer](https://blog.xkcd.com/2015/05/13/new-book-thing-explainer/) book, came the [text editor](http://splasho.com/upgoer5/).  My own take on using the text editor is below
